...
{
public:
	OutProcVSTPluginFilter(std::wstring libPath, std::wstring chunkData, std::unordered_map<std::wstring, float> paramMap, std::wstring hostId = L"", bool analysisMode = false);
